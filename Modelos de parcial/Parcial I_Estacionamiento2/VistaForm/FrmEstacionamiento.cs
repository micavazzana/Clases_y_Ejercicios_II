...
namespace VistaForm
{
    public partial class FrmEstacionamiento : Form
    {
        ...
        private void FrmEstacionamiento_Load(object sender, EventArgs e)
        {
            ...
            this.estacionamiento = Estacionamiento.GetEstacionamiento("Estacionamiento de Micaela Vazzana", 20);
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if ((Vehiculo.EVehiculos)this.cmbTipoVehiculo.SelectedItem == Vehiculo.EVehiculos.Automovil)
            {
                vehiculo = new Automovil(this.txtPatente.Text, DateTime.Now.AddHours(-3), this.txtMarca.Text);
            }
            else
            {
                vehiculo = new Moto(this.txtPatente.Text, DateTime.Now.AddHours(-3), (Moto.ETipo)this.cmbTipoMoto.SelectedItem);
            }
